...
trait SendEmailTrait
{
    ...
    public function sendEmail($receiver_mail, $msg_title, $msg_content)
    {
        ...
        try {
            ...
            $mail->Username = 'sphinxtravel.georgia@gmail.com'; //SMTP username
            $mail->Password = 'uqgl glyn cgbl cghc'; //SMTP password
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS; //Enable implicit TLS encryption
            $mail->Port = 465;
            //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

            //Recipients
            $mail->setFrom('sphinxtravel.georgia@gmail.com', 'Sphinx Travel');
